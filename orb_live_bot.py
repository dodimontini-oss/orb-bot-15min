...
SYMBOL = "QQQ"
ORB_WINDOW_MINUTES = 15  # differs between orb-bot-5min (5) and orb-bot-15min (15)
RR_RATIO = 2.0
...
MAX_LEVERAGE = 2.0
REL_VOL_THRESHOLD = None  # differs: 1.5 here (5min), None on orb-bot-15min (disabled) - see docstring point 6
